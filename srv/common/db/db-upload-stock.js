module.exports = {
    async stockCompany(service, ID, CCM) {
        let result;
        try {
    ...
    async getCompaniesForCNPJ(service, companyCNPJ) {
        let companies;
        try {
    ...
    async getEmptyCCMPrefec(service) {
        let prefectures;
    ...
    async insertIntoCompanies(tx, service, Company) {
    ...
    async insertIntoCompaniesPrefectures(tx, service, aCompaniesPrefectures) {
        let result;
